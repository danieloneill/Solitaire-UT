...
*/
    Rectangle {
        ...
        Text {
            ...
            color: suitColour
            text: valueLabel
            font.pixelSize: topContainer.isPortrait ? parent.height * 0.35 : parent.height * 0.18
            anchors {
                left: parent.left
                top: parent.top
                topMargin: topContainer.isPortrait ? 3 : 5
        ...
        Image {
            ...
            height: topContainer.isPortrait ? parent.height * 0.2 : parent.height * 0.1
            width: topContainer.isPortrait ? parent.height * 0.25 : parent.width * 0.1
            source: suitName+'.png'
            fillMode: Image.PreserveAspectFit
            smooth: true
        }
