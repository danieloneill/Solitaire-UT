...
Window {
    ...
    Item {
        ...
        property int cardSpacing: topContainer.width > topContainer.height ? cardHeight * 0.21 : cardHeight * 0.4
        property int cardWidth: topContainer.width * 0.1075
        property int cardHeight: topContainer.width < topContainer.height ? cardWidth / 0.71 : cardWidth / 0.84
        //property int cardHeight: cardWidth / 0.710059171597633
    ...
    Rectangle {
        ...
        width: configFlickable.width + 20
        height: configFlickable.height + 30
        radius: 10
        ...
        Flickable {
            ...
            width: configGrid.implicitWidth
            height: configGrid.height > topContainer.height - 40 ? topContainer.height - 40 : configGrid.height

            contentWidth: configGrid.width
            contentHeight: configGrid.height
            ...
            GridLayout {
                ...
                Slider {
                    ...
                    width: configFlickable.width * 0.20
                    live: false
                    from: 0
                    to: 1
...
/*
    MyRoundButton {
        id: closeConfigMenuButton
        visible: opacity > 0
        enabled: configMenu.opacity == 1
        opacity: configMenu.opacity
        anchors {
            left: configMenu.left
            top: configMenu.top
            margins: 0 - (closeConfigMenuButton.width * 0.5)
        }
    ...
    Rectangle {
        ...
        Flickable {
            ...
            TextEdit {
                ...
                color: 'white'
		font.pixelSize: topContainer.height * 0.025
